...
To mimic a porous media, we needed to fix some of the atoms in our system. This was done by adding an additional \function{Atom}{isPositionFixed} property to the \class{Atom} class. All atoms with this property set to ``true'' will be skipped by the integrator, and will not be included in force calculations when both atoms are fixed.
